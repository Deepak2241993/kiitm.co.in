...
@section('body')
    ...
    <style>
        ...
        .carousel-wrapper {
    margin-top: 80px; /* try 70–90px if needed */
}
    </style>
    <!-- Main Sllider Start -->
...
<div class="carousel-wrapper">
            ...
            <div class="carousel-inner">
                @foreach ($slider as $key => $value)
                    <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                        <img src="{{ url('images/sliders/' . $value->image) }}" class="d-block w-100 slider-img"
                            alt="slider image">
                    </div>
                @endforeach
            </div>
    ...
    <section class="counter-one">
        <div class="counter-one__bg"
            style="background-image: url({{ url('front') }}/assets/images/backgrounds/counter-one-bg.png);">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                            ...
                            <div class="accrodion-grp" data-grp-name="faq-two-accrodion">
                                @if (count($faq) > 0)
                                    @foreach ($faq as $key => $value)
                                        <div
                                            class="accrodion @if ($key == 1) {{ 'active' }} @endif">
                        ...
                        <div class="faq-two__img-box">
                            ...
                            <div class="faq-two__trusted">
                                <div class="faq-two__trusted-shape-1">
                                    <img src="{{ url('front') }}/assets/images/shapes/faq-two-trusted-shape-1.png"
                                        alt="">
                                </div>
                        ...
                        <div class="contact-one__points-and-signature-box">
                            ...
                            <div class="contact-one__signature-box">
                                <div class="contact-one__signature-img">
                                    <img src="{{ url('front') }}/assets/images/resources/contact-one-signature.png"
                                        alt="">
                                </div>
                                <p>CEO & Co Founder</p>
                            </div>
                                        ...
                                        <div class="contact-one__input-box">
                                            <select class="selectpicker" aria-label="Default select example"
                                                ...
                                                @foreach ($pages as $value)
                                                    <option value="{{ $value->page_title }}">{{ $value->page_title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
        ...
        <div class="container">
            <div class="section-title text-center">
                ...
                <h2 class="section-title__title">Latest News &
                    <br> Articles from the Blog
                </h2>
            </div>
            <div class="owl-carousel thm-owl__carousel owl-with-shadow"
                data-owl-options='{
                    "items": 1,
                    "dots": false,
                    "nav": false,
                            ...
                            <div class="blog-two__single">
                                <div class="blog-two__img-box">
                                    <div class="blog-two__img">
                                        <img src="{{ url('front') }}/assets/images/blog/{{ $value->image }}"
                                            alt="">
                                ...
                                <div class="blog-two__content">
                                    <div class="blog-two__user">
                                        <div class="blog-two__user-img">
                                            <img src="{{ url('front') }}/assets/images/blog/blog-two-user-img-1.jpg"
                                                alt="">
                                        </div>
                                    ...
                                    <h3 class="blog-two__title"><a
                                            href="{{ url('/blog/' . $value->slug) }}">{{ $value->name }}</a></h3>
                                    ...
                                    <div class="blog-two__comment-and-btn-box">
                                        <div class="blog-two__comment">
                                            <p><span
                                                    class="fas fa-calendar"></span>{{ date('d-M-Y', strtotime($value->created_at)) }}
                                            </p>
                                        </div>
