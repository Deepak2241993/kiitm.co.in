                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="{{url('images/clients/'.$value['image'])}}"  class="rounded img-fluid img-thumbnail"/></td>
                                {{-- <td>
                                ...
                                <td>
                                    <a href="{{route('clients.edit',$value->id)}}"><i class="bx bx-pencil"></i> Edit </a> | <a href="javascript:void(0);"  onClick="deletepages('{{$value->id}}')" class="text-danger"><i class="bx bx-trash-alt"></i> Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
