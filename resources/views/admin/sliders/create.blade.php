...
@endif
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    <label for="example-email-input" class="col-md-2 col-form-label">Image/Video<br/><span class="text-danger" >Image must be Upload in 1894 X 922 px</span></label>
                    @if(isset($slider))
                    ...
                    <div class="col-md-10" id="image_hide">
                        <input type="hidden" value="{{isset($slider)?$slider->id:''}}" id="gid">
                        <img src="{{url('/images/sliders/'.$slider->image)}}" style="height: 100px;"> <i class="bx bx-window-close text-danger" onClick="hideimage()"></i>
                    </div>
                    @endif
                    @endif
