...
@endif
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    <label for="example-email-input" class="col-md-2 col-form-label">Image<br/><span class="text-danger"> Size: 770 x 428 px </span></label>
                    @if(isset($blog))
                    <div class="col-md-10" id="image_hide">
                        <input type="hidden" value="{{isset($blog)?$blog->id:''}}" id="gid">
                        <img src="{{url('/images/blogs/'.$blog->image)}}" style="height: 100px;"> <i class="bx bx-window-close text-danger" onClick="hideimage()"></i>
                    </div>
                    @endif
