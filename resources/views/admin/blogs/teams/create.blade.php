            ...
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-10" id="image_hide">
                        ...
                        <img src="{{url('/images/teams/'.$team->image)}}" style="height: 100px;"> <i class="bx bx-window-close text-danger" onClick="hideimage()"></i>
                    </div>
                    @endif
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                        <input class="form-control" type="url" value="{{isset($team)?$team->social_link_1:''}}" placeholder="Enter Linkedin Url" id="" name="social_link_1">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="example-tel-input" class="col-md-2 col-form-label">Facebook</label>
                    <div class="col-md-10">
                        <input class="form-control" type="url" value="{{isset($team)?$team->social_link_2:''}}" name="social_link_2" placeholder="Enter Facebook url" id="example-tel-input">
                    </div>
                </div>
                <div class="mb-3 row">
