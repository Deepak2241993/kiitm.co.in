            ...
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-10" id="image_hide">
                        ...
                        <img src="{{url('/images/portfolios/'.$portfolio->image)}}" style="height: 100px;"> <i class="bx bx-window-close text-danger" onClick="hideimage()"></i>
                    </div>
                    @endif
                 ...
                 <div class="mb-3 row">
                    ...
                    <div class="col-md-10" id="bannerimage_hide">
                        ...
                        <img src="{{url('/images/portfolios/'.$portfolio->banner_image)}}" style="height: 100px;"> <i class="bx bx-window-close text-danger" onClick="bannerimage()"></i>
                    </div>
                    @endif
