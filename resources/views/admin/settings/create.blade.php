         ...
         <form method="post" action="{{url('admin/settings')}}" enctype="multipart/form-data" id="form-validation">
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="mb-3 row">
                     <label for="example-email-input" class="col-md-2 col-form-label">Website Logo<span class="text-danger">* 150X60 px</span></label>
                     @if(isset($data))
                     <div class="col-md-10" id="banner_image_hide">
                        <input type="hidden" value="{{isset($data)?$data->id:''}}" id="banner_id">
                        <img src="{{url('/images/settings/'.$data->web_logo)}}" style="height: 100px;"> <i class="bx bx-window-close text-danger" onClick="hidebannerimage()"></i>
                     </div>
                     @endif
