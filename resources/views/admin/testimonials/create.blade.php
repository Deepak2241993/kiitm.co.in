...
@endif
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    <label for="example-email-input" class="col-md-2 col-form-label">Image <span class="text-danger"><br/>Size must be 124 x 124 px,</span></label>
                    @if(isset($testimonial))
                    <div class="col-md-10" id="image_hide">
                        <input type="hidden" value="{{isset($testimonial)?$testimonial->id:''}}" id="gid">
                        <img src="{{url('/images/testimonials/'.$testimonial->image)}}" style="height: 100px;"> <i class="bx bx-window-close text-danger" onClick="hideimage()"></i>
                    </div>
                    @endif
