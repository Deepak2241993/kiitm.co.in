    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$value->name}}</td>
                                <td><img src="{{url('/images/testimonials/'.$value['image'])}}" style="height:124px"></td>
                                ...
                                <td>
                                    <a href="{{route('testimonials.edit',$value->id)}}"><i class="bx bx-pencil"></i> Edit </a> | <a href="javascript:void(0);"  onClick="deleteteams('{{$value->id}}')" class="text-danger"><i class="bx bx-trash-alt"></i> Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                ...
                {{$testimonial->links('vendor.pagination.simple-bootstrap-4')}}
...
<script>
    function deleteteams(tid){
        ...
        $.ajax({
            method:'DELETE',
            url: '{{ url('admin/testimonials/') }}/'+tid,
            data:{
                id: tid,
                _token: '{{ csrf_token() }}'
            },
