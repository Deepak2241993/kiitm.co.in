        ...
        @csrf
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        <label for="example-email-input" class="col-md-2 col-form-label">Image<span class="text-danger"> 770 X 381px</span></label>
                        ...
                        <div class="col-md-10" id="image_hide">
                            ...
                            <img src="{{url('/images/pages/'.$page->image)}}" style="height: 100px;"> <i class="bx bx-window-close text-danger" onClick="hideimage()"></i>
                        </div>
                        @endif
                    ...
                    <div class="mb-3 row" id="image_short_1">
                        <label for="image_short-0" class="col-md-2 col-form-label">PDF Upload<span class="text-danger">Size: Max 5MB</span> </label>
                    ...
                    <div class="mb-3 row">
                        <label for="example-email-input" class="col-md-2 col-form-label">Banner Image<span class="text-danger">1894 X 592 px</span></label>
                        ...
                        <div class="col-md-10" id="banner_image_hide">
                            ...
                            <img src="{{url('/images/banners/'.$page->banner_image)}}" style="height: 100px;"> <i class="bx bx-window-close text-danger" onClick="hidebannerimage()"></i>
                        </div>
                        @endif
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <button type="submit" class="btn btn-primary" >Submit</button>
                            <a href="{{url('/admin/pages')}}" type="submit"class="btn btn-warning">Back</a>
                        </div>
                    </div>
                </div>
            </div>
