...
<head>
    ...
    <body>
                            ...
                            <div class="bg-primary bg-soft">
                                <div class="row">
                                    ...
                                    <div class="col-12 align-self-end">
                                        <img src="{{url('/')}}/admin/assets/images/profile-img.png" alt="" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <a href="index.html">
                                        <div class="avatar-md profile-user-wid mb-4">
                                            <span class="avatar-title rounded-circle bg-light">
                                                <img src="{{url('/')}}/admin/assets/images/logo.svg" alt="" class="rounded-circle" height="34">
                                            </span>
                                        </div>
                                    </a>
                                </div>
                                <div class="p-2">
                                    <form class="needs-validation" novalidate action="https://themesbrand.com/skote-symfony/layouts/index.html">
        ...
        <!-- validation init -->
        <script src="{{url('/')}}/admin/assets/js/pages/validation.init.js"></script>
