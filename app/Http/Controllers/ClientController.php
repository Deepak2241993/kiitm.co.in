...
class ClientController extends Controller
{
    ...
    {
        $page_title="Our partners & college";
    ...
    {
        $page_title="Add Our partners & college";
    ...
    public function store(Request $request,Client $client)
    {
        ...
        return redirect('/admin/clients')->with('message','Data Added Successfully');
    }
    ...
    {
        $page_title="Edit Our partners & college";
    ...
    public function update(Request $request, Client $client)
    {
        $data=$request->all();
        $client->update($data);
        return redirect('/admin/clients')->with('message','Data Updated Successfully');
    }
